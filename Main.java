...
/**
 * Clase Main donde se ejecuta todos los metodos de las distintas clases y se muestra el laberinto
 * @author Victor
 *
 */
public class Main {
	 ...
	 * @param session Sesion a la que queremos gestionar el inicio de sesion del usuario
	 */
	...
	/**
	 * Metodo que muestra el menu con una sesion iniciada y permite manipular el laberinto
